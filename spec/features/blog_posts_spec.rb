feature 'Blog Posts' do
  scenario 'user create blog post' do
    ...
    expect(page).to have_content(I18n.t('cms.resources.created', resource: 'Post'))
  end
  ...
  scenario 'user update blog post' do
    ...
    expect(page).to have_content(I18n.t('cms.resources.updated', resource: 'Post'))
  end
  ...
  scenario 'user delete blog post' do
    ...
    expect(page.current_path).to eq(blog_posts_path)
    expect(page).to have_content(I18n.t('cms.resources.deleted', resource: 'Post'))
  end
end
